...
namespace Villa.Business.Validators
{
    public class QuestionValidator : AbstractValidator<Quest>
    {
        public QuestionValidator()
        {
            ...
            RuleFor(x => x.Question).MinimumLength(10).WithMessage("Minumum 10 karakterlik bir soru giriniz");
            ...
            RuleFor(x => x.Answer).MinimumLength(10).WithMessage("Minumum 10 karakterlik bir cevap giriniz");
